...
public class ShulkerFactoryStructure extends Structure<NoFeatureConfig> {
     ...
     * spawn here.
     * 
     * Notice how the biome is also passed in. While you could do manual checks on
     * the biome to see if you can spawn here, that is highly discouraged. Instead,
     * you should do the biome check in the FMLCommonSetupEvent event (setup method
     * in StructureTutorialMain) and add your structure to the biome with
     * .addFeature and .addStructure methods.
     * 
     * Instead, this method is best used for determining if the chunk position
     * itself is valid, if certain other structures are too close or not, or some
     * other restrictive condition.
     *
    ...
    public static class Start extends StructureStart {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ,
            ...
            // where it is.
            Cobbler.LOGGER.log(Level.DEBUG,
                    "Shulker Factory at " + (blockpos.getX()) + " " + blockpos.getY() + " " + (blockpos.getZ()));
        }
