...
public class CobblerConfig {
    public static class CobblerConfigValues {
        ...
        CobblerConfigValues(ForgeConfigSpec.Builder builder, ConfigHelper.Subscriber subscriber) {
            ...
            spawnShulkerFactories = subscriber.subscribe(builder.comment(
            ...
            addMapsToShulkerFactoriesToEndCities = subscriber.subscribe(builder.comment(
                    "\r\n Whether or not to add a map, similar to the ones which cartographers sell, to the loot table for"
                            ...
                            + "\r\n Default value is true")
                    .translation(
                            "repurposedstructures.config.feature.endStructures.addMapsToShulkerFactoriesToEndCities")
            ...
            bonemealSaplingSpawnAttempts = subscriber.subscribe(builder.comment(
            ...
            desertSaplingsMaxDeathrate = subscriber.subscribe(builder.comment(
            ...
            desertSaplingsMinDeathrate = subscriber.subscribe(builder.comment(
            ...
            endermenCanPickupAndPlaceCocoa = subscriber.subscribe(builder.comment(
                    "\r\n Whether or Endermen can place cocoa. This overrides any changes to enderman_holdable for cocoa and works with MobGreifing turned off if set to true"
                            + "\r\n Default value is true")
                    .translation("repurposedstructures.config.feature.farmability.endermenCanPickupAndPlaceCocoa")
                    .define("endermenCanPickupAndPlaceCocoa", true));
